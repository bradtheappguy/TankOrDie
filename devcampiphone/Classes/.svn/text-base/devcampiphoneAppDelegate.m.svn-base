...
#ifdef NEWPROTOCOL	
	NSString *string = [NSString stringWithFormat:@"confirmiPhone|%i",tank_id];
...
#endif
	NSError *error;
	//GKSession *session = [(devcampiphoneAppDelegate *)[[UIApplication sharedApplication] delegate] session];
